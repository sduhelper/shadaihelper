...
public class ActivityCalendar2ics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calendar2ics);
        getDateWeekNum();
    ...
    private void getDateWeekNum () {
        ...
        Log.i(TAG, "getDateWeekNum: "+maxWeekNum);
    }
    ...
    private void writeFile(net.fortuna.ical4j.model.Calendar cld) throws IOException {
        try {
            ...
            pfd.close();
            Toast.makeText(ActivityCalendar2ics.this, "Save Success! Find file at: "+xlsUri, Toast.LENGTH_SHORT).show();
        } catch (java.lang.SecurityException e) {
            Toast.makeText(ActivityCalendar2ics.this, "Please select path again: "+ e, Toast.LENGTH_SHORT).show();
        } catch (java.lang.NullPointerException err) {
            Toast.makeText(ActivityCalendar2ics.this, "Please click CHOOSE to choose file again: "+ err, Toast.LENGTH_SHORT).show();
        }
    }
    ...
    class ChooseButton implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            Toast.makeText(ActivityCalendar2ics.this, "Choose the .xls file downloaded from school website!", Toast.LENGTH_SHORT).show();
        }
    }
        ...
        public void onClick(View v) {
            ...
            try {
                try {
                    ...
                    Toast.makeText(ActivityCalendar2ics.this, "Please choose file save location", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(ActivityCalendar2ics.this, "Please CHOOSE again: "+ er, Toast.LENGTH_SHORT).show();
                } catch (java.lang.RuntimeException runtime) {
                    Toast.makeText(ActivityCalendar2ics.this, "Please CHOOSE again: "+ runtime, Toast.LENGTH_SHORT).show();
                }
